...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.disAssistantSuggestions = QtWidgets.QListWidget(self.centralwidget)
        self.disAssistantSuggestions.setGeometry(QtCore.QRect(810, 100, 251, 161))
        self.disAssistantSuggestions.setObjectName("disAssistantSuggestions")
        self.disAssistantHUD = QtWidgets.QTextEdit(self.centralwidget)
        self.disAssistantHUD.setGeometry(QtCore.QRect(810, 280, 251, 251))
        self.disAssistantHUD.setReadOnly(True)
