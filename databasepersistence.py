...
class DatabasePersistence:
    ...
    def read_all_secondary_database_data(self):
        ...
        sql_unit_query = "SELECT Enhed.enhed_navn FROM Enhed;"
        ...
        queries = [[sql_recipe_names_query, 'recipe_titles'], [sql_unit_query, 'units'], [sql_tags_query, 'tags'], [sql_ingr_function_query, 'ingredient_functions'], [sql_ingr_category_query, 'ingredient_categories'], [sql_type_query, 'recipe_types']]
